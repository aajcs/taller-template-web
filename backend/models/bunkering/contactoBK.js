...
const ContactoBKSchema = new Schema(
  {
    // Relación con el modelo Bunkdering
    idBunkering: {
...
ContactoBKSchema.index(
  { idBunkdering: 1, identificacionFiscal: 1 },
  { unique: true }
);
ContactoBKSchema.plugin(auditPlugin);

ContactoBKSchema.set("toJSON", {
...
module.exports = model("ContactoBK", ContactoBKSchema);
