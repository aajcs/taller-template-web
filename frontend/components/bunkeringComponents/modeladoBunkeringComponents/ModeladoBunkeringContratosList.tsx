...
interface ModeladoBunkeringContratosListProps {
...
const ModeladoBunkeringContratosList = ({
  contratos,
  onShowDialog,
  onShowDialogDespachos,
}: ModeladoBunkeringContratosListProps) => {
  return (
    <div className="">
      <div className="grid">
        {contratos
...
export default ModeladoBunkeringContratosList;
